...
export default function Settings() {
  ...
  const { voiceProps: settingsVoiceProps } = useVoiceTrigger({
    ...
    how: "Navigate between tabs to customize different aspects of the system including voice tutorial settings."
  });
  
  const { voiceProps: voiceSettingsProps } = useVoiceTrigger({
    what: "These settings control how the voice tutorial system works.",
    how: "Adjust these settings to customize the voice assistant's behavior, like changing the voice persona or tutorial level."
  });
  ...
  return (
    <>
      ...
      <Tabs defaultValue="general" className="space-y-8" {...settingsVoiceProps}>
        ...
        <TabsContent value="voice" {...voiceSettingsProps}>
          <Card>
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue={voicePersona} onValueChange={setVoicePersona}>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue={voiceTutorialLevel} onValueChange={setVoiceTutorialLevel}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="intermediate">Intermediate (How to use)</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue={voiceSpeed} onValueChange={setVoiceSpeed}>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="howTo" defaultChecked />
                    <Label htmlFor="howTo" className="text-sm">
                      "How & Why" (Click tutorials)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
